...
func (p *SaveArticleSummaryRequest) GetOutlineString() (v []string) {
	return p.OutlineString
}
...
func (p *SaveArticleSummaryRequest) SetOutlineString(val []string) {
	p.OutlineString = val
}
...
func (p *SaveArticleSummaryRequest) ReadField9(iprot thrift.TProtocol) error {
...
func (p *SaveArticleSummaryRequest) writeField7(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("OutlineString", thrift.LIST, 7); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteListBegin(thrift.STRING, len(p.OutlineString)); err != nil {
		return err
	}
...
func (p *SaveArticleSummaryRequest) writeField9(oprot thrift.TProtocol) (err error) {
...
func (p *SaveArticleSummaryRequest) DeepEqual(ano *SaveArticleSummaryRequest) bool {
	...
	if !p.Field7DeepEqual(ano.OutlineString) {
		return false
	}
...
func (p *SaveArticleSummaryRequest) Field7DeepEqual(src []string) bool {
	...
	if len(p.OutlineString) != len(src) {
		return false
	}
	for i, v := range p.OutlineString {
		_src := src[i]
		if strings.Compare(v, _src) != 0 {
			return false
		}
...
func (p *SaveArticleSummaryRequest) Field8DeepEqual(src []string) bool {
...
func (p *SaveArticleSummaryRequest) Field9DeepEqual(src int32) bool {
...
type GetSymbolRequest struct {
	...
	SymbolTag *string `thrift:"SymbolTag,2,optional" frugal:"2,optional,string" json:"SymbolTag,omitempty"`
}

func NewGetSymbolRequest() *GetSymbolRequest {
	return &GetSymbolRequest{}
}

func (p *GetSymbolRequest) InitDefault() {
	*p = GetSymbolRequest{}
}

var GetSymbolRequest_ID_DEFAULT string

func (p *GetSymbolRequest) GetID() (v string) {
	if !p.IsSetID() {
		return GetSymbolRequest_ID_DEFAULT
	}
	return *p.ID
}

var GetSymbolRequest_SymbolTag_DEFAULT string

func (p *GetSymbolRequest) GetSymbolTag() (v string) {
	if !p.IsSetSymbolTag() {
		return GetSymbolRequest_SymbolTag_DEFAULT
	}
	return *p.SymbolTag
}
func (p *GetSymbolRequest) SetID(val *string) {
	p.ID = val
}
func (p *GetSymbolRequest) SetSymbolTag(val *string) {
	p.SymbolTag = val
}

var fieldIDToName_GetSymbolRequest = map[int16]string{
	1: "ID",
	2: "SymbolTag",
}

func (p *GetSymbolRequest) IsSetID() bool {
	return p.ID != nil
}

func (p *GetSymbolRequest) IsSetSymbolTag() bool {
	return p.SymbolTag != nil
}

func (p *GetSymbolRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GetSymbolRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *GetSymbolRequest) ReadField1(iprot thrift.TProtocol) error {
...
func (p *GetSymbolRequest) ReadField2(iprot thrift.TProtocol) error {
...
func (p *GetSymbolRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetSymbolRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *GetSymbolRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetID() {
		if err = oprot.WriteFieldBegin("ID", thrift.STRING, 1); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *GetSymbolRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetSymbolTag() {
		if err = oprot.WriteFieldBegin("SymbolTag", thrift.STRING, 2); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.SymbolTag); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *GetSymbolRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GetSymbolRequest(%+v)", *p)

}

func (p *GetSymbolRequest) DeepEqual(ano *GetSymbolRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	...
	if !p.Field2DeepEqual(ano.SymbolTag) {
		return false
	}
	return true
}

func (p *GetSymbolRequest) Field1DeepEqual(src *string) bool {
...
func (p *GetSymbolRequest) Field2DeepEqual(src *string) bool {

	if p.SymbolTag == src {
		return true
	} else if p.SymbolTag == nil || src == nil {
		return false
	}
	if strings.Compare(*p.SymbolTag, *src) != 0 {
		return false
	}
	return true
}

type GetSybmolResponse struct {
	Symbol *Symbol `thrift:"Symbol,1,required" frugal:"1,required,Symbol" json:"Symbol"`
}

func NewGetSybmolResponse() *GetSybmolResponse {
	return &GetSybmolResponse{}
}

func (p *GetSybmolResponse) InitDefault() {
	*p = GetSybmolResponse{}
}

var GetSybmolResponse_Symbol_DEFAULT *Symbol

func (p *GetSybmolResponse) GetSymbol() (v *Symbol) {
	if !p.IsSetSymbol() {
		return GetSybmolResponse_Symbol_DEFAULT
	}
	return p.Symbol
}
func (p *GetSybmolResponse) SetSymbol(val *Symbol) {
	p.Symbol = val
}

var fieldIDToName_GetSybmolResponse = map[int16]string{
	1: "Symbol",
}

func (p *GetSybmolResponse) IsSetSymbol() bool {
	return p.Symbol != nil
}

func (p *GetSybmolResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GetSybmolResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_GetSybmolResponse[fieldId]))
}

func (p *GetSybmolResponse) ReadField1(iprot thrift.TProtocol) error {
	p.Symbol = NewSymbol()
	if err := p.Symbol.Read(iprot); err != nil {
		return err
	}
	return nil
}

func (p *GetSybmolResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetSybmolResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *GetSybmolResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("Symbol", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Symbol.Write(oprot); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *GetSybmolResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GetSybmolResponse(%+v)", *p)

}

func (p *GetSybmolResponse) DeepEqual(ano *GetSybmolResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GetSybmolResponse) Field1DeepEqual(src *Symbol) bool {

	if !p.Symbol.DeepEqual(src) {
		return false
	}
	return true
}
...
type UpdateSymbolRequest struct {
	ID              string  `thrift:"ID,1,required" frugal:"1,required,string" json:"ID"`
	Company         *string `thrift:"Company,2,optional" frugal:"2,optional,string" json:"Company,omitempty"`
	CompanyZH       *string `thrift:"CompanyZH,3,optional" frugal:"3,optional,string" json:"CompanyZH,omitempty"`
	CompanyUrl      *string `thrift:"CompanyUrl,4,optional" frugal:"4,optional,string" json:"CompanyUrl,omitempty"`
	CompanyAddress  *string `thrift:"CompanyAddress,5,optional" frugal:"5,optional,string" json:"CompanyAddress,omitempty"`
	Description     *string `thrift:"Description,6,optional" frugal:"6,optional,string" json:"Description,omitempty"`
	CompanyBusiness *string `thrift:"CompanyBusiness,7,optional" frugal:"7,optional,string" json:"CompanyBusiness,omitempty"`
}

func NewUpdateSymbolRequest() *UpdateSymbolRequest {
	return &UpdateSymbolRequest{}
}

func (p *UpdateSymbolRequest) InitDefault() {
	*p = UpdateSymbolRequest{}
}

func (p *UpdateSymbolRequest) GetID() (v string) {
	return p.ID
}

var UpdateSymbolRequest_Company_DEFAULT string

func (p *UpdateSymbolRequest) GetCompany() (v string) {
	if !p.IsSetCompany() {
		return UpdateSymbolRequest_Company_DEFAULT
	}
	return *p.Company
}

var UpdateSymbolRequest_CompanyZH_DEFAULT string

func (p *UpdateSymbolRequest) GetCompanyZH() (v string) {
	if !p.IsSetCompanyZH() {
		return UpdateSymbolRequest_CompanyZH_DEFAULT
	}
	return *p.CompanyZH
}

var UpdateSymbolRequest_CompanyUrl_DEFAULT string

func (p *UpdateSymbolRequest) GetCompanyUrl() (v string) {
	if !p.IsSetCompanyUrl() {
		return UpdateSymbolRequest_CompanyUrl_DEFAULT
	}
	return *p.CompanyUrl
}

var UpdateSymbolRequest_CompanyAddress_DEFAULT string

func (p *UpdateSymbolRequest) GetCompanyAddress() (v string) {
	if !p.IsSetCompanyAddress() {
		return UpdateSymbolRequest_CompanyAddress_DEFAULT
	}
	return *p.CompanyAddress
}

var UpdateSymbolRequest_Description_DEFAULT string

func (p *UpdateSymbolRequest) GetDescription() (v string) {
	if !p.IsSetDescription() {
		return UpdateSymbolRequest_Description_DEFAULT
	}
	return *p.Description
}

var UpdateSymbolRequest_CompanyBusiness_DEFAULT string

func (p *UpdateSymbolRequest) GetCompanyBusiness() (v string) {
	if !p.IsSetCompanyBusiness() {
		return UpdateSymbolRequest_CompanyBusiness_DEFAULT
	}
	return *p.CompanyBusiness
}
func (p *UpdateSymbolRequest) SetID(val string) {
	p.ID = val
}
func (p *UpdateSymbolRequest) SetCompany(val *string) {
	p.Company = val
}
func (p *UpdateSymbolRequest) SetCompanyZH(val *string) {
	p.CompanyZH = val
}
func (p *UpdateSymbolRequest) SetCompanyUrl(val *string) {
	p.CompanyUrl = val
}
func (p *UpdateSymbolRequest) SetCompanyAddress(val *string) {
	p.CompanyAddress = val
}
func (p *UpdateSymbolRequest) SetDescription(val *string) {
	p.Description = val
}
func (p *UpdateSymbolRequest) SetCompanyBusiness(val *string) {
	p.CompanyBusiness = val
}

var fieldIDToName_UpdateSymbolRequest = map[int16]string{
	1: "ID",
	2: "Company",
	3: "CompanyZH",
	4: "CompanyUrl",
...
func (p *UpdateSymbolRequest) IsSetCompany() bool {
	return p.Company != nil
}

func (p *UpdateSymbolRequest) IsSetCompanyZH() bool {
	return p.CompanyZH != nil
}

func (p *UpdateSymbolRequest) IsSetCompanyUrl() bool {
	return p.CompanyUrl != nil
}

func (p *UpdateSymbolRequest) IsSetCompanyAddress() bool {
	return p.CompanyAddress != nil
}

func (p *UpdateSymbolRequest) IsSetDescription() bool {
	return p.Description != nil
}

func (p *UpdateSymbolRequest) IsSetCompanyBusiness() bool {
	return p.CompanyBusiness != nil
}

func (p *UpdateSymbolRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UpdateSymbolRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_UpdateSymbolRequest[fieldId]))
}

func (p *UpdateSymbolRequest) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UpdateSymbolRequest) ReadField2(iprot thrift.TProtocol) error {
...
func (p *UpdateSymbolRequest) ReadField3(iprot thrift.TProtocol) error {
...
func (p *UpdateSymbolRequest) ReadField4(iprot thrift.TProtocol) error {
...
func (p *UpdateSymbolRequest) ReadField5(iprot thrift.TProtocol) error {
...
func (p *UpdateSymbolRequest) ReadField6(iprot thrift.TProtocol) error {
...
func (p *UpdateSymbolRequest) ReadField7(iprot thrift.TProtocol) error {
...
func (p *UpdateSymbolRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UpdateSymbolRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UpdateSymbolRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("ID", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.ID); err != nil {
...
func (p *UpdateSymbolRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetCompany() {
		if err = oprot.WriteFieldBegin("Company", thrift.STRING, 2); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.Company); err != nil {
			return err
...
func (p *UpdateSymbolRequest) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetCompanyZH() {
		if err = oprot.WriteFieldBegin("CompanyZH", thrift.STRING, 3); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.CompanyZH); err != nil {
			return err
...
func (p *UpdateSymbolRequest) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetCompanyUrl() {
		if err = oprot.WriteFieldBegin("CompanyUrl", thrift.STRING, 4); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.CompanyUrl); err != nil {
			return err
...
func (p *UpdateSymbolRequest) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetCompanyAddress() {
		if err = oprot.WriteFieldBegin("CompanyAddress", thrift.STRING, 5); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.CompanyAddress); err != nil {
			return err
...
func (p *UpdateSymbolRequest) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetDescription() {
...
func (p *UpdateSymbolRequest) writeField7(oprot thrift.TProtocol) (err error) {
	if p.IsSetCompanyBusiness() {
		if err = oprot.WriteFieldBegin("CompanyBusiness", thrift.STRING, 7); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.CompanyBusiness); err != nil {
			return err
...
func (p *UpdateSymbolRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UpdateSymbolRequest(%+v)", *p)

}

func (p *UpdateSymbolRequest) DeepEqual(ano *UpdateSymbolRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	...
	if !p.Field2DeepEqual(ano.Company) {
		return false
	}
	if !p.Field3DeepEqual(ano.CompanyZH) {
		return false
	}
	if !p.Field4DeepEqual(ano.CompanyUrl) {
		return false
	}
	if !p.Field5DeepEqual(ano.CompanyAddress) {
		return false
	}
	if !p.Field6DeepEqual(ano.Description) {
		return false
	}
	if !p.Field7DeepEqual(ano.CompanyBusiness) {
		return false
	}
	return true
}

func (p *UpdateSymbolRequest) Field1DeepEqual(src string) bool {
...
func (p *UpdateSymbolRequest) Field2DeepEqual(src *string) bool {

	if p.Company == src {
		return true
	} else if p.Company == nil || src == nil {
		return false
	}
	if strings.Compare(*p.Company, *src) != 0 {
		return false
...
func (p *UpdateSymbolRequest) Field3DeepEqual(src *string) bool {

	if p.CompanyZH == src {
		return true
	} else if p.CompanyZH == nil || src == nil {
		return false
	}
	if strings.Compare(*p.CompanyZH, *src) != 0 {
		return false
...
func (p *UpdateSymbolRequest) Field4DeepEqual(src *string) bool {

	if p.CompanyUrl == src {
		return true
	} else if p.CompanyUrl == nil || src == nil {
		return false
	}
	if strings.Compare(*p.CompanyUrl, *src) != 0 {
		return false
...
func (p *UpdateSymbolRequest) Field5DeepEqual(src *string) bool {

	if p.CompanyAddress == src {
		return true
	} else if p.CompanyAddress == nil || src == nil {
		return false
	}
	if strings.Compare(*p.CompanyAddress, *src) != 0 {
		return false
...
func (p *UpdateSymbolRequest) Field6DeepEqual(src *string) bool {
...
func (p *UpdateSymbolRequest) Field7DeepEqual(src *string) bool {

	if p.CompanyBusiness == src {
		return true
	} else if p.CompanyBusiness == nil || src == nil {
		return false
	}
	if strings.Compare(*p.CompanyBusiness, *src) != 0 {
		return false
...
func NewUpdateSymbolResponse() *UpdateSymbolResponse {
	return &UpdateSymbolResponse{}
}

func (p *UpdateSymbolResponse) InitDefault() {
	*p = UpdateSymbolResponse{}
}

func (p *UpdateSymbolResponse) GetSuccess() (v bool) {
	return p.Success
}
func (p *UpdateSymbolResponse) SetSuccess(val bool) {
	p.Success = val
}

var fieldIDToName_UpdateSymbolResponse = map[int16]string{
	1: "Success",
}

func (p *UpdateSymbolResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UpdateSymbolResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_UpdateSymbolResponse[fieldId]))
}

func (p *UpdateSymbolResponse) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UpdateSymbolResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UpdateSymbolResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UpdateSymbolResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("Success", thrift.BOOL, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteBool(p.Success); err != nil {
...
func (p *UpdateSymbolResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UpdateSymbolResponse(%+v)", *p)

}

func (p *UpdateSymbolResponse) DeepEqual(ano *UpdateSymbolResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UpdateSymbolResponse) Field1DeepEqual(src bool) bool {
...
type SpeedyRead interface {
	...
	UpdateSymbol(ctx context.Context, req *UpdateSymbolRequest) (r *UpdateSymbolResponse, err error)
	...
	GetSymbol(ctx context.Context, req *GetSymbolRequest) (r *GetSybmolResponse, err error)
...
func (p *SpeedyReadClient) ImportSymbol(ctx context.Context, req *Request) (r *Response, err error) {
	...
	_args.Req = req
	var _result SpeedyReadImportSymbolResult
	if err = p.Client_().Call(ctx, "importSymbol", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *SpeedyReadClient) UpdateSymbol(ctx context.Context, req *UpdateSymbolRequest) (r *UpdateSymbolResponse, err error) {
	var _args SpeedyReadUpdateSymbolArgs
	_args.Req = req
	var _result SpeedyReadUpdateSymbolResult
	if err = p.Client_().Call(ctx, "UpdateSymbol", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func (p *SpeedyReadClient) GetSymbol(ctx context.Context, req *GetSymbolRequest) (r *GetSybmolResponse, err error) {
	var _args SpeedyReadGetSymbolArgs
	_args.Req = req
	var _result SpeedyReadGetSymbolResult
	if err = p.Client_().Call(ctx, "GetSymbol", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewSpeedyReadProcessor(handler SpeedyRead) *SpeedyReadProcessor {
	...
	self.AddToProcessorMap("UpdateSymbol", &speedyReadProcessorUpdateSymbol{handler: handler})
	...
	self.AddToProcessorMap("GetSymbol", &speedyReadProcessorGetSymbol{handler: handler})
...
type speedyReadProcessorImportSymbol struct {
	handler SpeedyRead
}

func (p *speedyReadProcessorImportSymbol) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := SpeedyReadImportSymbolArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("importSymbol", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := SpeedyReadImportSymbolResult{}
	var retval *Response
	if retval, err2 = p.handler.ImportSymbol(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing importSymbol: "+err2.Error())
		oprot.WriteMessageBegin("importSymbol", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
...
type speedyReadProcessorUpdateSymbol struct {
	handler SpeedyRead
}

func (p *speedyReadProcessorUpdateSymbol) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := SpeedyReadUpdateSymbolArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("UpdateSymbol", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := SpeedyReadUpdateSymbolResult{}
	var retval *UpdateSymbolResponse
	if retval, err2 = p.handler.UpdateSymbol(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing UpdateSymbol: "+err2.Error())
		oprot.WriteMessageBegin("UpdateSymbol", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("UpdateSymbol", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type speedyReadProcessorGetSymbol struct {
	handler SpeedyRead
}

func (p *speedyReadProcessorGetSymbol) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := SpeedyReadGetSymbolArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetSymbol", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := SpeedyReadGetSymbolResult{}
	var retval *GetSybmolResponse
	if retval, err2 = p.handler.GetSymbol(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetSymbol: "+err2.Error())
		oprot.WriteMessageBegin("GetSymbol", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("GetSymbol", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type SpeedyReadImportSymbolArgs struct {
	Req *Request `thrift:"req,1" frugal:"1,default,Request" json:"req"`
}

func NewSpeedyReadImportSymbolArgs() *SpeedyReadImportSymbolArgs {
	return &SpeedyReadImportSymbolArgs{}
}

func (p *SpeedyReadImportSymbolArgs) InitDefault() {
	*p = SpeedyReadImportSymbolArgs{}
}

var SpeedyReadImportSymbolArgs_Req_DEFAULT *Request

func (p *SpeedyReadImportSymbolArgs) GetReq() (v *Request) {
	if !p.IsSetReq() {
		return SpeedyReadImportSymbolArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *SpeedyReadImportSymbolArgs) SetReq(val *Request) {
	p.Req = val
}

var fieldIDToName_SpeedyReadImportSymbolArgs = map[int16]string{
	1: "req",
}

func (p *SpeedyReadImportSymbolArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *SpeedyReadImportSymbolArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SpeedyReadImportSymbolArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SpeedyReadImportSymbolArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
...
func (p *SpeedyReadImportSymbolArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("importSymbol_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *SpeedyReadImportSymbolArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *SpeedyReadImportSymbolArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SpeedyReadImportSymbolArgs(%+v)", *p)

}

func (p *SpeedyReadImportSymbolArgs) DeepEqual(ano *SpeedyReadImportSymbolArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SpeedyReadImportSymbolArgs) Field1DeepEqual(src *Request) bool {
...
type SpeedyReadImportSymbolResult struct {
	Success *Response `thrift:"success,0,optional" frugal:"0,optional,Response" json:"success,omitempty"`
}

func NewSpeedyReadImportSymbolResult() *SpeedyReadImportSymbolResult {
	return &SpeedyReadImportSymbolResult{}
}

func (p *SpeedyReadImportSymbolResult) InitDefault() {
	*p = SpeedyReadImportSymbolResult{}
}

var SpeedyReadImportSymbolResult_Success_DEFAULT *Response

func (p *SpeedyReadImportSymbolResult) GetSuccess() (v *Response) {
	if !p.IsSetSuccess() {
		return SpeedyReadImportSymbolResult_Success_DEFAULT
	}
	return p.Success
}
func (p *SpeedyReadImportSymbolResult) SetSuccess(x interface{}) {
	p.Success = x.(*Response)
}

var fieldIDToName_SpeedyReadImportSymbolResult = map[int16]string{
	0: "success",
}

func (p *SpeedyReadImportSymbolResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SpeedyReadImportSymbolResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SpeedyReadImportSymbolResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SpeedyReadImportSymbolResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
...
func (p *SpeedyReadImportSymbolResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("importSymbol_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *SpeedyReadImportSymbolResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *SpeedyReadImportSymbolResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SpeedyReadImportSymbolResult(%+v)", *p)

}

func (p *SpeedyReadImportSymbolResult) DeepEqual(ano *SpeedyReadImportSymbolResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
type SpeedyReadUpdateSymbolArgs struct {
	Req *UpdateSymbolRequest `thrift:"req,1" frugal:"1,default,UpdateSymbolRequest" json:"req"`
}

func NewSpeedyReadUpdateSymbolArgs() *SpeedyReadUpdateSymbolArgs {
	return &SpeedyReadUpdateSymbolArgs{}
}

func (p *SpeedyReadUpdateSymbolArgs) InitDefault() {
	*p = SpeedyReadUpdateSymbolArgs{}
}

var SpeedyReadUpdateSymbolArgs_Req_DEFAULT *UpdateSymbolRequest

func (p *SpeedyReadUpdateSymbolArgs) GetReq() (v *UpdateSymbolRequest) {
	if !p.IsSetReq() {
		return SpeedyReadUpdateSymbolArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *SpeedyReadUpdateSymbolArgs) SetReq(val *UpdateSymbolRequest) {
	p.Req = val
}

var fieldIDToName_SpeedyReadUpdateSymbolArgs = map[int16]string{
	1: "req",
}

func (p *SpeedyReadUpdateSymbolArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *SpeedyReadUpdateSymbolArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SpeedyReadUpdateSymbolArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SpeedyReadUpdateSymbolArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewUpdateSymbolRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *SpeedyReadUpdateSymbolArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UpdateSymbol_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *SpeedyReadUpdateSymbolArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *SpeedyReadUpdateSymbolArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SpeedyReadUpdateSymbolArgs(%+v)", *p)

}

func (p *SpeedyReadUpdateSymbolArgs) DeepEqual(ano *SpeedyReadUpdateSymbolArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SpeedyReadUpdateSymbolArgs) Field1DeepEqual(src *UpdateSymbolRequest) bool {
...
type SpeedyReadUpdateSymbolResult struct {
	Success *UpdateSymbolResponse `thrift:"success,0,optional" frugal:"0,optional,UpdateSymbolResponse" json:"success,omitempty"`
}

func NewSpeedyReadUpdateSymbolResult() *SpeedyReadUpdateSymbolResult {
	return &SpeedyReadUpdateSymbolResult{}
}

func (p *SpeedyReadUpdateSymbolResult) InitDefault() {
	*p = SpeedyReadUpdateSymbolResult{}
}

var SpeedyReadUpdateSymbolResult_Success_DEFAULT *UpdateSymbolResponse

func (p *SpeedyReadUpdateSymbolResult) GetSuccess() (v *UpdateSymbolResponse) {
	if !p.IsSetSuccess() {
		return SpeedyReadUpdateSymbolResult_Success_DEFAULT
	}
	return p.Success
}
func (p *SpeedyReadUpdateSymbolResult) SetSuccess(x interface{}) {
	p.Success = x.(*UpdateSymbolResponse)
}

var fieldIDToName_SpeedyReadUpdateSymbolResult = map[int16]string{
	0: "success",
}

func (p *SpeedyReadUpdateSymbolResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SpeedyReadUpdateSymbolResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SpeedyReadUpdateSymbolResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SpeedyReadUpdateSymbolResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewUpdateSymbolResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *SpeedyReadUpdateSymbolResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UpdateSymbol_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *SpeedyReadUpdateSymbolResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *SpeedyReadUpdateSymbolResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SpeedyReadUpdateSymbolResult(%+v)", *p)

}

func (p *SpeedyReadUpdateSymbolResult) DeepEqual(ano *SpeedyReadUpdateSymbolResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SpeedyReadUpdateSymbolResult) Field0DeepEqual(src *UpdateSymbolResponse) bool {
...
type SpeedyReadGetSymbolArgs struct {
	Req *GetSymbolRequest `thrift:"req,1" frugal:"1,default,GetSymbolRequest" json:"req"`
}

func NewSpeedyReadGetSymbolArgs() *SpeedyReadGetSymbolArgs {
	return &SpeedyReadGetSymbolArgs{}
}

func (p *SpeedyReadGetSymbolArgs) InitDefault() {
	*p = SpeedyReadGetSymbolArgs{}
}

var SpeedyReadGetSymbolArgs_Req_DEFAULT *GetSymbolRequest

func (p *SpeedyReadGetSymbolArgs) GetReq() (v *GetSymbolRequest) {
	if !p.IsSetReq() {
		return SpeedyReadGetSymbolArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *SpeedyReadGetSymbolArgs) SetReq(val *GetSymbolRequest) {
	p.Req = val
}

var fieldIDToName_SpeedyReadGetSymbolArgs = map[int16]string{
	1: "req",
}

func (p *SpeedyReadGetSymbolArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *SpeedyReadGetSymbolArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SpeedyReadGetSymbolArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SpeedyReadGetSymbolArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewGetSymbolRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *SpeedyReadGetSymbolArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetSymbol_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *SpeedyReadGetSymbolArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *SpeedyReadGetSymbolArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SpeedyReadGetSymbolArgs(%+v)", *p)

}

func (p *SpeedyReadGetSymbolArgs) DeepEqual(ano *SpeedyReadGetSymbolArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SpeedyReadGetSymbolArgs) Field1DeepEqual(src *GetSymbolRequest) bool {
...
type SpeedyReadGetSymbolResult struct {
	Success *GetSybmolResponse `thrift:"success,0,optional" frugal:"0,optional,GetSybmolResponse" json:"success,omitempty"`
}

func NewSpeedyReadGetSymbolResult() *SpeedyReadGetSymbolResult {
	return &SpeedyReadGetSymbolResult{}
}

func (p *SpeedyReadGetSymbolResult) InitDefault() {
	*p = SpeedyReadGetSymbolResult{}
}

var SpeedyReadGetSymbolResult_Success_DEFAULT *GetSybmolResponse

func (p *SpeedyReadGetSymbolResult) GetSuccess() (v *GetSybmolResponse) {
	if !p.IsSetSuccess() {
		return SpeedyReadGetSymbolResult_Success_DEFAULT
	}
	return p.Success
}
func (p *SpeedyReadGetSymbolResult) SetSuccess(x interface{}) {
	p.Success = x.(*GetSybmolResponse)
}

var fieldIDToName_SpeedyReadGetSymbolResult = map[int16]string{
	0: "success",
}

func (p *SpeedyReadGetSymbolResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SpeedyReadGetSymbolResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SpeedyReadGetSymbolResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SpeedyReadGetSymbolResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewGetSybmolResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *SpeedyReadGetSymbolResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetSymbol_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *SpeedyReadGetSymbolResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *SpeedyReadGetSymbolResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("SpeedyReadGetSymbolResult(%+v)", *p)

}

func (p *SpeedyReadGetSymbolResult) DeepEqual(ano *SpeedyReadGetSymbolResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *SpeedyReadGetSymbolResult) Field0DeepEqual(src *GetSybmolResponse) bool {
