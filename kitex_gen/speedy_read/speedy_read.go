...
type ArticleSummary struct {
	...
	TradingProposal int32                  `thrift:"TradingProposal,9,required" frugal:"9,required,i32" json:"TradingProposal"`
	SymbolList      []*Symbol              `thrift:"SymbolList,10,optional" frugal:"10,optional,list<Symbol>" json:"SymbolList,omitempty"`
}
...
var ArticleSummary_SymbolList_DEFAULT []*Symbol

func (p *ArticleSummary) GetSymbolList() (v []*Symbol) {
	if !p.IsSetSymbolList() {
		return ArticleSummary_SymbolList_DEFAULT
	}
	return p.SymbolList
}
...
func (p *ArticleSummary) SetSymbolList(val []*Symbol) {
	p.SymbolList = val
}
...
func (p *ArticleSummary) IsSetSymbolList() bool {
	return p.SymbolList != nil
}
...
func (p *ArticleSummary) writeField10(oprot thrift.TProtocol) (err error) {
	if p.IsSetSymbolList() {
		if err = oprot.WriteFieldBegin("SymbolList", thrift.LIST, 10); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ArticleSummary) DeepEqual(ano *ArticleSummary) bool {
	...
	if !p.Field10DeepEqual(ano.SymbolList) {
		return false
	}
	return true
}
...
func (p *ArticleSummary) Field10DeepEqual(src []*Symbol) bool {
